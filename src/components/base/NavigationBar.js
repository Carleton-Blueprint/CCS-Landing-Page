    ...
    <div className='container h-14 md:h-16'>
      ...
      <div className='flex items-center justify-end w-screen gap-10 text-white md:hidden bg-gradient-to-r from-neutral-900 to-red-700 font-poppins'>
        ...
        <AnimatePresence>
          ...
          <li className={`my-16 ${currentpath === '/' ? 'font-bold' : 'font-normal'}`}>HOME</li>
          <li className={`my-16 ${isCurrentPath('/about') ? 'font-bold' : 'font-normal'}`}>ABOUT US</li>
          <li className={`my-16 ${isCurrentPath('/events') ? 'font-bold' : 'font-normal'}`}>EVENTS</li>
          <li className={`my-16 ${isCurrentPath('/FAQ') ? 'font-bold' : 'font-normal'}`}>FAQ</li>
          <li className={`my-16 ${isCurrentPath('/contact') ? 'font-bold' : 'font-normal'}`}>CONTACT</li>
              </ul>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <div className='items-center justify-end hidden w-screen gap-20 text-white md:flex bg-gradient-to-r from-neutral-900 to-red-700 font-poppins'>
        <ul className='flex items-center justify-end gap-20 pr-20'>
          ...
          <li className={`${isCurrentPath('/about') ? 'font-bold' : 'font-normal'}`}>ABOUT US</li>
          <li className={`${isCurrentPath('/events') ? 'font-bold' : 'font-normal'}`}>EVENTS</li>
          <li className={`${isCurrentPath('/FAQ') ? 'font-bold' : 'font-normal'}`}>FAQ</li>
          <li className={`${isCurrentPath('/contact') ? 'font-bold' : 'font-normal'}`}>CONTACT</li>
        </ul>
      </div>
    </div>
  )
