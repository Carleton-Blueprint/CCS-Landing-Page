    ...
    <div className='container h-14 md:h-16'>
      ...
      <div className='flex items-center justify-end w-screen gap-10 text-white md:hidden bg-gradient-to-r from-neutral-900 to-red-700 font-poppins'>
        ...
        <AnimatePresence>
          ...
          <li className={`my-16 ${currentpath === '/' ? 'font-bold' : 'font-semibold'}`}>HOME</li>
          <li className={`my-16 ${isCurrentPath('/about') ? 'font-bold' : 'font-semibold'}`}>ABOUT US</li>
          <li className={`my-16 ${isCurrentPath('/events') ? 'font-bold' : 'font-semibold'}`}>EVENTS</li>
          <li className={`my-16 ${isCurrentPath('/FAQ') ? 'font-bold' : 'font-semibold'}`}>FAQ</li>
          <li className={`my-16 ${isCurrentPath('/contact') ? 'font-bold' : 'font-semibold'}`}>CONTACT</li>
              </ul>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <div className='items-center justify-end hidden w-screen gap-20 text-white md:flex bg-gradient-to-r from-neutral-900 to-red-700 font-poppins'>
        <ul className='flex items-center justify-end gap-20 pr-20'>
          ...
          <li className={`${isCurrentPath('/events') ? 'font-bold' : 'font-semibold'}`}>EVENTS</li>
