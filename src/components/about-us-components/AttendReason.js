...
const AttendReason = (props) => {
  ...
  return (
    <div className="flex group [perspective:1000px] w-full h-full">
        <div className={`relative w-full h-full [transform-style:preserve-3d] transition-all duration-500 ${ props.isCenter && flipped &&'[transform:rotateY(180deg)]'}`} onClick={() => setFlipped(!flipped)}>
